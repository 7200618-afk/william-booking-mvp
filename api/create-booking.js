...
<body>
  ...
  <script>
    ...
    const modalStylistEl = document.getElementById("modalStylist");
    ...
    function rebindModalElements() {
      window.closeBookingModalBtnNow = document.getElementById("closeBookingModal");
      window.modalTimeElNow = document.getElementById("modalTime");
      window.modalStylistElNow = document.getElementById("modalStylist");
      window.modalServiceElNow = document.getElementById("modalService");
      window.firstNameElNow = document.getElementById("firstName");
      window.lastNameElNow = document.getElementById("lastName");
      window.customerPhoneElNow = document.getElementById("customerPhone");
      window.customerEmailElNow = document.getElementById("customerEmail");
      window.customerNoteElNow = document.getElementById("customerNote");
      window.confirmBookingBtnNow = document.getElementById("confirmBookingBtn");
      window.bookingStatusElNow = document.getElementById("bookingStatus");

      window.closeBookingModalBtnNow.addEventListener("click", closeBookingModal);
      window.confirmBookingBtnNow.addEventListener("click", confirmBooking);
    }
    ...
    function openBookingModal(slot) {
      ...
      document.getElementById("modalTime").textContent = `${formatFullDate(currentDate)} · ${formatPasadenaTime(slot.start_at)} PT`;
      document.getElementById("modalStylist").textContent = staff.name;
      document.getElementById("modalService").textContent = `${service.label} · ${formatPrice(service.price)} · ${service.duration_minutes} min`;
